...
from RETFound_MAE.util.datasets import build_dataset
...
from RETFound_MAE.engine_finetune import train_one_epoch, evaluate
...
def main(args):
    ...
    if args.distributed:
        print(f"Distributed mode initialized with rank {args.rank} and world size {args.world_size}")
    else:
