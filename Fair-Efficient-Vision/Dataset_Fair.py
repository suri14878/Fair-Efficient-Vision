    ...
    def __getitem__(self, idx):
        ...
        if 'glaucoma' in data.files:
            ...
            if data['dr_class'] == 0:
                ...
                label = 2
        attributes = [data['race'],data['male'],data['hispanic'],data['maritalstatus'],data['language'] ]
        flattened_attributes = [attr.item() for attr in attributes]
...
#         print(attributes)
        attributes = torch.tensor(flattened_attributes)
#         print(attributes)
